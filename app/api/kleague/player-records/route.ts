...
const allowedSortFields = new Set(["goals", "assists", "offencePoints", "yellowCards", "matchesPlayed", "bestEleven", "mom"]);
...
export async function GET(request: Request) {
  ...
  const sortField = allowedSortFields.has(sortFieldParam) ? (sortFieldParam as "goals" | "assists" | "offencePoints" | "yellowCards" | "matchesPlayed" | "bestEleven" | "mom") : "goals";
